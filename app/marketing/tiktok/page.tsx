...
export default function TikTokAdsPage() {
  ...
  const reportTotals = data?.report ? data.report.reduce((acc: any, r: any) => ({
  ...
  }), { spend: 0, impressions: 0, clicks: 0, conversions: 0 }) : null
            ...
            {data.report && data.report.length > 0 && (() => {
              ...
              return (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      <div className="text-2xl font-bold">{formatCurrency(parseFloat(latest.cost_per_conversion ?? 0))}</div>
