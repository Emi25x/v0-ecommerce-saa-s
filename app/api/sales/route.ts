...
export async function GET(request: Request) {
  ...
  let query = supabase
    .from("orders")
    .select("id, platform, platform_code, platform_order_id, company_name, libral_reference, customer_name, order_date, total, status, payment_status, libral_status, export_error, last_export_attempt_at, sent_to_libral, libral_sent_at, cancelled_at", { count: "exact" })
