...
async function searchProductsGraphQL(shop_domain: string, access_token: string, rawQuery: string, limit: number) {
  ...
  const res = await fetch(`https://${shop_domain}/admin/api/2024-01/graphql.json`, {
    method: "POST",
    headers: {
...
export async function GET(request: Request) {
  try {
    ...
    const res = await fetch(`https://${store.shop_domain}/admin/api/2024-01/products.json?${params}`, {
