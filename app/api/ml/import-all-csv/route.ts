...
export async function POST() {
  try {
    ...
    const csvUrl = "https://blobs.vusercontent.net/blob/Publicaciones-2026_02_05-19_59%28Publicaciones%29-wUYvrnbsEQqOrzhs6clJDXGo1vSkv2.csv"
    ...
    console.log(`[v0] Procesamiento completo: ${processed} procesadas, ${inserted} nuevas, ${updated} actualizadas, ${linked} vinculadas`)
