  ...
  try {
    ...
    if (sqlError && (sqlError.code === "PGRST202" || sqlError.code === "42883")) {
      ...
      return NextResponse.json({
        ...
        instructions:
          'Por favor ejecuta el script SQL "EJECUTAR_PRIMERO_crear_funciones.sql" que se encuentra en la carpeta scripts/ usando el SQL Editor de Supabase para habilitar el análisis completo de duplicados.',
