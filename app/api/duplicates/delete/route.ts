      ...
      return NextResponse.json(
        {
          ...
          instructions:
            'Por favor ejecuta el script SQL "EJECUTAR_PRIMERO_crear_funciones.sql" que se encuentra en la carpeta scripts/ usando el SQL Editor de Supabase para habilitar la eliminación automática de duplicados.',
