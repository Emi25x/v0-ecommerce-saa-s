    ...
    <div className="max-w-2xl space-y-5">
            ...
            <div className="rounded-lg border border-blue-500/30 bg-blue-500/5 p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Derivando de{" "}
                  <span className="font-medium text-foreground">{origen.nombre_empresa || origen.razon_social}</span>.
                  El CUIT y certificado ya fueron copiados. Solo completa el numero de punto de venta y el nombre
                  interno.
                </p>
              </div>
              <button
              ...
              {!confirmDelete ? (
                ...
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <Button
                    size="sm"
                    variant="destructive"
                    onClick={() => deleteEmpresa(configForm.id)}
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              PNG o JPG, max. 2MB. Se mostrara en el encabezado de cada factura.
            </p>
            <label className="cursor-pointer">
              ...
              />
              <span
                className={`inline-flex items-center gap-2 rounded-md border border-border bg-muted/30 px-3 py-1.5 text-xs font-medium hover:bg-muted/60 transition-colors ${uploadingLogo ? "opacity-60 pointer-events-none" : ""}`}
              >
                {uploadingLogo ? (
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setConfigForm((p) => ({ ...p, cuit: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setConfigForm((p) => ({ ...p, punto_venta: e.target.value }))}
            />
          </div>
          <div className="col-span-2 space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setConfigForm((p) => ({ ...p, razon_social: e.target.value }))}
            />
          </div>
          <div className="col-span-2 space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setConfigForm((p) => ({ ...p, domicilio_fiscal: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setConfigForm((p) => ({ ...p, condicion_iva: v }))}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setConfigForm((p) => ({ ...p, telefono: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              value={configForm.web}
              onChange={(e) => setConfigForm((p) => ({ ...p, web: e.target.value }))}
            />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => setConfigForm((p) => ({ ...p, facebook: e.target.value }))}
              />
            </div>
          </div>
        </div>
      ...
      <div className="rounded-lg border border-border bg-card p-5 space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            Se aplica automaticamente a cada item nuevo al crear una factura.
          </p>
          <Select
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            Aparece al pie de todas las facturas (ej: "Gracias por su compra", condiciones de devolucion, etc.)
          </p>
          <Textarea
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            CBU, alias, Mercado Pago, etc. Se muestra como seccion destacada en la factura.
          </p>
          <Textarea
      ...
      <div className="rounded-lg border border-border bg-card p-5 space-y-4">
        ...
        <p className="text-xs text-muted-foreground">
          El certificado .pem y la clave privada se obtienen al dar de alta el servicio en el portal de ARCA. Consulta
          la pestana "Como tramitar el certificado" para instrucciones detalladas.
        </p>
      ...
      <div className="rounded-lg border border-border bg-card p-5 space-y-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Elegi que secciones aparecen en el PDF de cada factura por defecto.
          </p>
        </div>
        <div className="grid grid-cols-2 gap-3">
          {(
            ...
            ] as { key: keyof typeof configForm.factura_opciones; label: string }[]
          ).map(({ key, label }) => (
      ...
      {configMsg && (
        <div
          className={`rounded-lg border p-3 text-sm flex items-center gap-2 ${configMsg.type === "ok" ? "border-emerald-500/30 bg-emerald-500/10 text-emerald-400" : "border-red-500/30 bg-red-500/10 text-red-400"}`}
        >
          {configMsg.type === "ok" ? (
